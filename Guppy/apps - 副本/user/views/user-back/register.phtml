...
<script type="text/javascript">
	$(document).ready(function() {
		$("#img_validateCode").click(function(){
				//alert("hz");
		        $(this).attr("src",'/Faeva/public/ValifyCode.php?' + Math.random());
		});
 ...
 <body ng-app="" ng-controller="validateCtrl">
	...
	<div class="row">
		<div class="span12">
		<form class="form-horizontal" method="post" action="/Faeva/user/user/register" name="myForm" novalidate>
						...
						<tr >
							<td>
								<div class="control-group">
									...
									<input id="inputUname" type="text" name="uname" value="anxing" ng-model="user" required>
								</div>
							</td>
							<td>
						...
						<tr >
							<td>
								<div class="control-group">
									...
									<input id="inputEmail" type="email" name="email" value="1965198272@qq.com" ng-model="email" required/>
								</div>
							</td>
							<td>
						...
						<tr>
							<td>
								<div class="control-group">
									...
									<input id="inputPassword" type="password" name="pw" value="123123" ng-model="pw" required/>
								</div>
							</td>
							<td>
						...
						<tr>
							<td>
								<div class="control-group">
									...
									<input id="inputPassword2" type="password" name="pw2" value="123123" ng-model="pw2" required/>
								</div>
							</td>
						...
						<tr>
							<td>
								<div class="control-group">
									...
									<img src="/Faeva/public/ValifyCode.php" id="img_validateCode"/>
								</div>
							</td>
							<td>
