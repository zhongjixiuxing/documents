...
<script type="text/javascript">
 ...
 <body ng-app="" ng-controller="validateCtrl">
  ...
  <div class="row">
    <div class="span12">
    <form class="form-horizontal" method="post" action="/Faeva2/user/user/login" name="myForm" novalidate>
            ...
            <tr>
              <td>
                <div class="control-group">
                     ...
                     <button type="submit" class="btn" ng-disabled="false" ng-click="mySubmit()"> 登录 </button>
                  </div>
                </div>
              </td>
            </tr>
