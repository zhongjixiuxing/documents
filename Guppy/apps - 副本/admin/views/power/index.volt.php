...
<body>
  ...
  <br>
    ...
    <tbody>
		appId : <?php echo $this->session->appId; ?>
	<br>
  <?php print_r($power->powers[0]);?>
    <ul>
      <ul>
      <?php foreach ($power->powers as $pow) { ?>
        <li>name: <?php echo $pow['name']; ?>
            <a href='/Faeva/admin/power/delete/<?php echo $pow['pid']; ?>'> delete</a> |
            <a href='/Faeva/admin/power/edit/<?php echo $pow['pid']; ?>'> edit</a><br>
            <li>pid : <?php echo $pow['pid']; ?> <br>
            <li>controller : <?php echo $pow['controller']; ?><br>
            <li>options : <br>
            <ul>
            <?php foreach ($pow['options'] as $opt) { ?>


                <li>name : <?php echo $opt['name']; ?>
                <a href='/Faeva/admin/power/deleteOption/<?php echo $pow['pid']; ?>/<?php echo $opt['oid']; ?>'> delete</a> |
                <a href='/Faeva/admin/power/editOption/<?php echo $pow['pid']; ?>/<?php echo $opt['oid']; ?>'> edit</a> |
                <a href='/Faeva/admin/power/addOption/<?php echo $pow['pid']; ?>'> add</a><br>
                <li>action :<?php echo $opt['action']; ?> <br>
                <br>
            <?php } ?>
          </ul>
      <?php } ?>
