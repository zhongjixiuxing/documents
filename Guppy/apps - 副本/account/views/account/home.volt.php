...
<a id="a_createApp">Creates App</a>
  ...
  <div data-role="content" class="content">
    ...
    <?php if (empty($apps)) { ?>
    <?php } else { ?>
      <?php $v14761453801iterated = false; ?><?php foreach ($apps as $app) { ?><?php $v14761453801iterated = true; ?>
        <p>
          <div class="panel" id="">
            <div class="content">
              <div class="ui-grid-a">
               <div class="ui-block-a"><span class="app_name"><?php echo $app->name; ?></span></div>
               <div class="ui-block-b"><span></span></div>
               <div class="ui-block-c" align="right"><span id="<?php echo $app->appId; ?>" class="img img_setup icon icon-add"></span></div>
               <div class="ui-block-d" align="right"><span id="<?php echo $app->appId; ?>" class="img img_del icon icon-delete"></span></div>
              </div>

              <div class="ui-grid-b">
               <div class="ui-block-a"> </div>
               <div class="ui-block-b"><span><?php echo $app->desc; ?></span></div>
