...
class ResizeImage
{
  ...
  function myresizeimage($img, $corner, $wid, $hei,$c, $corner_radius, $angle)
   {
       $this->srcimg = $img;
       $this->corner = $corner;
   ...
   function newimg()
   {
       ...
       //裁图
       {
        ...
        imagecopyresampled($newimg, $this->im, 0, 0, $this->x, $this->y, $this->width, $this->height, $this->resize_width, $this->resize_height);
        ...
        imagepng ($tmp,$this->dstimg);
          ...
          //       echo "<br> 宽度优先";
          //      $newimg = imagecreatetruecolor($this->resize_width,$this->resize_height);
          //      imagecopyresampled($newimg, $this->im, 0, 0, 200, 200, $this->resize_width, $this->resize_height, $this->width, (($this->width)/$resize_ratio));
          //      $tmp = $this->rounded_corner($newimg, $this->resize_height);
          //      imagepng ($tmp,$this->dstimg);
          //  }
       }
   ...
   function rounded_corner($image,$size)
   {
        ...
        $bottomright = true;
        $topright = true;
        $corner_source = imagecreatefrompng('D:\software install\xampp\htdocs\imageDir\test_small.png');
